  ...
  <div class="div-header">
    ...
    <div class="div-header-search">
      <form action="" method="get" class="search">
        <div class="span left">
          <span class="message">{l s="Rechercher"}</span>
        </div>
        <div class="center">
          <input type="text" name="search" id="search" placeholder={l s="Rechercher une pièce"} />
        </div>
    ...
    <div class="div-header-search div-header-search-second">
      <!-- Search -->
      <form action="" method="get" class="search">
        <div class="span left">
          <span class="message">{l s="Rechercher"}</span>
